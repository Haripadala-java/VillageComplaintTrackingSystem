...
CREATE DATABASE IF NOT EXISTS village_complaint_tracking_db;
USE village_complaint_tracking_db;
...
VALUES ('admin', 'admin123', 'admin@village.com', 'System Administrator', 'owner', '9999999999')
ON DUPLICATE KEY UPDATE username=username;

-- Insert sample user (password: user123)
INSERT INTO residents (username, password, email, full_name, role, phone) 
VALUES ('user1', 'user123', 'user1@village.com', 'John Doe', 'user', '8888888888')
ON DUPLICATE KEY UPDATE username=username;
