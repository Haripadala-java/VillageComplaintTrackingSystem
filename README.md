# 🏘️ Village Complaint Tracking System
...
```bash
git clone https://github.com/Haripadala-java/VillageComplaintTrackingSystem.git
cd VillageComplaintTrackingSystem
```
...
3. **Database will be created automatically** by Hibernate when you run the application!
   - Database name: `village_complaint_tracking_db`
...
```
VillageComplaintTrackingSystem/
├── src/main/java/
...
2. **Admin Secret Key**: `Village2026` (change in `AdminSignupServlet.java` for production)
...
**Hari Padala**  
GitHub: [@Haripadala-java](https://github.com/Haripadala-java)
